      ...
      <section className="section bg-gradient-to-b from-gray-900 to-gray-950">
        <div className="container">
          <div className="mx-auto max-w-4xl text-center mb-12 md:mb-16 ">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-8 text-white">You&apos;re Stuck in the Agency Trap</h2>
            
            {/* Qualifier Checklist */}
            <div className="max-w-2xl mx-auto text-left bg-gray-800/50 backdrop-blur rounded-xl p-6 sm:p-8 shadow-xl border border-gray-700 mb-12">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <p className="text-base font-medium text-gray-300">You run an agency with $10K+ monthly revenue</p>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <p className="text-base font-medium text-gray-300">You&apos;re tired of trading time for money</p>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <p className="text-base font-medium text-gray-300">You want to build products but don&apos;t know where to start</p>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                  </svg>
                  <p className="text-base font-medium text-gray-300">You&apos;re NOT looking for get-rich-quick schemes</p>
                </div>
              </div>
            </div>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="bg-gradient-to-br from-gray-800 to-gray-850 rounded-xl lg:rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-700 h-full">
                ...
                <h3 className="text-xl sm:text-2xl font-black mb-2 sm:mb-3 text-white">Working Weekends While Friends Party</h3>
            ...
            <div className="group">
              <div className="bg-gradient-to-br from-gray-800 to-gray-850 rounded-xl lg:rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-700 h-full">
                ...
                <h3 className="text-xl sm:text-2xl font-black mb-2 sm:mb-3 text-white">Copy-Pasting Your Own Code... Again</h3>
                <p className="text-base font-medium text-gray-400 leading-relaxed">
            ...
            {/* Problem 3 */}
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="bg-gradient-to-br from-gray-800 to-gray-850 rounded-xl lg:rounded-2xl p-6 sm:p-8 shadow-xl h-full relative border-2 border-red-500/50 animate-pulse-border">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-red-500 to-red-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-4 sm:mb-6 ">
                  <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-xl sm:text-2xl font-black mb-2 sm:mb-3 text-white">Can&apos;t Afford That Dream Setup</h3>
                <p className="text-base font-medium text-gray-400 leading-relaxed">
